...
import {_} from './SugarCubesUtils.js'
 ...
 */
function SC_cubify(){
  defineConstantProperty(this, "SC_cubeAddBehaviorEvt", new SC_Event("addBehaviorEvt"));
  defineConstantProperty(this, "SC_cubeKillEvt", new SC_Event("killSelf"));
  defineConstantProperty(this, "SC_cubeCellifyEvt", new SC_Event("cellifyEvt"));
  defineConstantProperty(this, "SC_cubeAddCellEvt", new SC_Event("addCellEvt"));
  Object.defineProperty(this, "$SC_cellMaker"
                           , { enumerable:false
                               , value:new SC_Cell({init:null, sideEffect: function(val, evts, m){
                                     ...
                                     for(var i = 0 ; i < (undefined === cellifyRequests)?0:cellifyRequests.length; i++){
                                       ...
                                       Object.defineProperty(this
                                                             , "$"+nom
                                                             , {
                                                               value : new SC_Cell({target:t, field:nom, sideEffect: _(this,"_"+nom), eventList: el})
                                                               }
                                                             );
                                       }
                                     ...
                                     for(var i = 0 ; i < cellifyRequests.length; i++){
                                       ...
                                       Object.defineProperty(this
                                                             , "$"+nom
                                                             , {
                                                               value : new SC_Cell({init:init, sideEffect: _(this,"_"+nom), eventList: el})
                                                               }
                                                             );
...
function SC_Machine(delay, params){
  ...
  this.name = ((undefined === params)||(undefined === params.name))?"machine_undefined":params.name;
  ...
  this.traceEvt = new SC_Event("traceEvt");
  /*this.traces = [];
  ...
  if(undefined != params && undefined != params.init){
    ...
    this.addProgram(SC_PauseForever);
    }
  this.ips = 0;
...
// SC_Module.prototype.process = function(aRW){
  ...
  // for(var i in this.globalEvents){
    ...
    // if(evt in aRW.events){
      ...
      // }
    // else {
      // var zeSCEvent = new SC_Event(evt.getID());
...
export {_SC, SC_Event, SC_Generate, SC_GenerateOne, SC_GenerateForever, SC_Action, SC_ActionOnEvent, SC_Par, SC_Seq, SC_Cube, Kill, SC_Machine, SC_Cell, SC_Send, SC_Nothing, SC_Pause, SC_PauseRT, SC_CubePause, SC_Await, NO_FUN, SC_LoopPoint, SC_RelativeJump, SC_RepeatPoint, SC_And, SC_Or, Control, SC_Test, When, Match, SC_Filter, Mark, SC_ValueWrapper };
// export {SC_Event};