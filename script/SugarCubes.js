 ...
 *   ex : SC.repeat(10, ...)
 *                  ^^
 * - l'Ã©valuation Ã  la construction (une fonction Ã©valuÃ©e, retourne la constante Ã  utiliser)
 *   ex : SC.repeat(fun(), ...)
 *                  ^^^^^
 */
...
/*******************************************************************************
 * Events
 * Les Ã©vÃ©nements sont des valeurs glaobals paratagÃ©es entre tous les
 * composants d'un programme. La valeur est prÃ©sent ou absent Ã  chaque instant.
 ...
 * numÃ©ro d'instant de sa derniÃ¨re gÃ©nÃ©ration est le numÃ©ro d'instnat courrant
...
/*
 * RÃ©veil des instructions sur liste d'attente pour l'Ã©vennement. Si cela ne
 * suffit pas Ã  dÃ©bloquer l'instruction (qui reste bloquÃ©e sur d'autres
 * Ã©vÃ©nementsn l'instruction non dÃ©bloquÃ©e est remise dans la liste d'attente
...
SC_Cube.prototype = {
  ...
  , bindTo : function(engine, parbranch, seq, masterSeq, path, cube){
      ...
      const dieEvt = SC.evt("dyingEvent");
